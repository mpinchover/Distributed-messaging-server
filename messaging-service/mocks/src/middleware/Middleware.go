...
import (
	middleware "messaging-service/src/middleware"
...
func (_m *Middleware) Execute(_a0 middleware.HTTPHandler) middleware.HTTPHandler {
	...
	if rf, ok := ret.Get(0).(func(middleware.HTTPHandler) middleware.HTTPHandler); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(middleware.HTTPHandler)
		}
	}
