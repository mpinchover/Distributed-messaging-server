...
// RepoInteface is an autogenerated mock type for the RepoInteface type
type RepoInteface struct {
	mock.Mock
}

// DeleteRoom provides a mock function with given fields: roomUUID
func (_m *RepoInteface) DeleteRoom(roomUUID string) error {
...
func (_m *RepoInteface) GetAuthProfileByEmail(email string) (*records.AuthProfile, error) {
	ret := _m.Called(email)
...
func (_m *RepoInteface) GetMembersByRoomUUID(roomUUID string) ([]*records.Member, error) {
	ret := _m.Called(roomUUID)
...
func (_m *RepoInteface) GetMessageByUUID(uuid string) (*records.Message, error) {
	ret := _m.Called(uuid)
...
func (_m *RepoInteface) GetMessagesByRoomUUID(roomUUID string, offset int) ([]*records.Message, error) {
...
func (_m *RepoInteface) GetMessagesByRoomUUIDs(roomUUIDs string, offset int) ([]*records.Message, error) {
...
func (_m *RepoInteface) GetRoomByRoomUUID(roomUUID string) (*records.Room, error) {
	ret := _m.Called(roomUUID)
...
func (_m *RepoInteface) GetRoomsByUserUUID(uuid string, offset int) ([]*records.Room, error) {
...
func (_m *RepoInteface) LeaveRoom(userUUID string, roomUUID string) error {
...
func (_m *RepoInteface) SaveAuthProfile(authProfile *records.AuthProfile) error {
...
func (_m *RepoInteface) SaveMessage(msg *records.Message) error {
	ret := _m.Called(msg)
...
func (_m *RepoInteface) SaveRoom(room *records.Room) error {
	ret := _m.Called(room)
...
func (_m *RepoInteface) SaveSeenBy(seenBy *records.SeenBy) error {
...
func (_m *RepoInteface) UpdateMessage(message *records.Message) error {
...
func (_m *RepoInteface) UpdatePassword(email string, hashedPassword string) error {
...
// NewRepoInteface creates a new instance of RepoInteface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewRepoInteface(t interface {
	mock.TestingT
	Cleanup(func())
}) *RepoInteface {
	mock := &RepoInteface{}
