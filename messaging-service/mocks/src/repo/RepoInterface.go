...
// GetBlockedCandidatesByUser provides a mock function with given fields: userUUID
func (_m *RepoInterface) GetBlockedCandidatesByUser(userUUID string) ([]string, error) {
...
// GetLikedQuestionUUIDsByUserUUID provides a mock function with given fields: userUUID
func (_m *RepoInterface) GetLikedQuestionUUIDsByUserUUID(userUUID string) ([]string, error) {
	ret := _m.Called(userUUID)
...
// GetLikedTrackedQuestionByUserUUIDAndCandidates provides a mock function with given fields: userUUID, candidateUUIDs
func (_m *RepoInterface) GetLikedTrackedQuestionByUserUUIDAndCandidates(userUUID string, candidateUUIDs []string) ([]*records.TrackedQuestion, error) {
	ret := _m.Called(userUUID, candidateUUIDs)

	var r0 []*records.TrackedQuestion
	var r1 error
	if rf, ok := ret.Get(0).(func(string, []string) ([]*records.TrackedQuestion, error)); ok {
		return rf(userUUID, candidateUUIDs)
	}
	if rf, ok := ret.Get(0).(func(string, []string) []*records.TrackedQuestion); ok {
		r0 = rf(userUUID, candidateUUIDs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*records.TrackedQuestion)
		}
	}

	if rf, ok := ret.Get(1).(func(string, []string) error); ok {
		r1 = rf(userUUID, candidateUUIDs)
	} else {
		r1 = ret.Error(1)
	}
...
// GetQuestionsLikedByMatchedCandidateUUIDs provides a mock function with given fields: questionUUIDs, candidateUUIDs
func (_m *RepoInterface) GetQuestionsLikedByMatchedCandidateUUIDs(questionUUIDs []string, candidateUUIDs []string) ([]*records.TrackedQuestion, error) {
	ret := _m.Called(questionUUIDs, candidateUUIDs)

	var r0 []*records.TrackedQuestion
	var r1 error
	if rf, ok := ret.Get(0).(func([]string, []string) ([]*records.TrackedQuestion, error)); ok {
		return rf(questionUUIDs, candidateUUIDs)
	}
	if rf, ok := ret.Get(0).(func([]string, []string) []*records.TrackedQuestion); ok {
		r0 = rf(questionUUIDs, candidateUUIDs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*records.TrackedQuestion)
		}
	...
	if rf, ok := ret.Get(1).(func([]string, []string) error); ok {
		r1 = rf(questionUUIDs, candidateUUIDs)
	} else {
		r1 = ret.Error(1)
	}
...
// GetTrackedQuestionsByUserUUID provides a mock function with given fields: userUUID
func (_m *RepoInterface) GetTrackedQuestionsByUserUUID(userUUID string) ([]*records.TrackedQuestion, error) {
	ret := _m.Called(userUUID)

	var r0 []*records.TrackedQuestion
	var r1 error
	if rf, ok := ret.Get(0).(func(string) ([]*records.TrackedQuestion, error)); ok {
		return rf(userUUID)
	}
	if rf, ok := ret.Get(0).(func(string) []*records.TrackedQuestion); ok {
		r0 = rf(userUUID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*records.TrackedQuestion)
...
// UpdateTrackedQuestion provides a mock function with given fields: trackedQuestions
func (_m *RepoInterface) UpdateTrackedQuestion(trackedQuestions *records.TrackedQuestion) error {
	ret := _m.Called(trackedQuestions)

	var r0 error
	if rf, ok := ret.Get(0).(func(*records.TrackedQuestion) error); ok {
		r0 = rf(trackedQuestions)
	} else {
		r0 = ret.Error(0)
	}
